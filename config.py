...
PLAYER_RADIUS: float = np.sqrt(PLAYER_WIDTH**2 + PLAYER_HEIGHT**2) / 2
...
BOT_DEFAULT_RADIUS: float = np.sqrt(BOT_DEFAULT_WIDTH**2 + BOT_DEFAULT_HEIGHT**2) / 2


BOT_DEFAULT_SPEED: float = PLAYER_SPEED * 0.6

BOT_DEFAULT_SPAWN_RANGE: int = 200  # R - r for ring
BOT_DEFAULT_SPAWN_RADIUS: float = PLAYER_RADIUS + BOT_DEFAULT_RADIUS + 100  # r for ring


MIN_DEFAULT_SPAWN_DISTANCE_FROM_PLAYER: float = BOT_DEFAULT_SPAWN_RADIUS
MAX_DEFAULT_SPAWN_DISTANCE_FROM_PLAYER: float = (
...
BOT_SPRINTER_RADIUS: float = np.sqrt(BOT_SPRINTER_WIDTH**2 + BOT_SPRINTER_HEIGHT**2) / 2


BOT_SPRINTER_SPEED: float = 0.95 * PLAYER_SPEED
BOT_SPRINTER_TIME_TO_MAX_SPEED: int = 3

BOT_SPRINTER_SPAWN_RANGE: int = BOT_DEFAULT_SPAWN_RANGE  # R - r for ring
BOT_SPRINTER_SPAWN_RADIUS: float = (
    PLAYER_RADIUS + BOT_SPRINTER_RADIUS + 100 + 500
)  # r for ring


MIN_SPRINTER_SPAWN_DISTANCE_FROM_PLAYER: float = BOT_SPRINTER_SPAWN_RADIUS
MAX_SPRINTER_SPAWN_DISTANCE_FROM_PLAYER: float = (
